...
pub const VisionEncoder = struct {
    ...
    pub fn saveDebugData(self: *const VisionEncoder, io: std.Io, allocator: std.mem.Allocator, cgraph: *ggml.CGraph) void {
        ...
        const save_entries = [_]encoder_debug.DebugTensorEntry{
            ...
            .{ .tensor_name = "Kcur-0",             .filename = "zllama_vision_04b3_Kcur.json" },
            .{ .tensor_name = "Vcur-0",             .filename = "zllama_vision_04b4_Vcur.json" },
            .{ .tensor_name = "Qcur_pos-0",         .filename = "zllama_vision_04b5_Ocur_pos.json" },
            .{ .tensor_name = "Kcur_pos-0",         .filename = "zllama_vision_04b6_Kcur_pos.json" },
